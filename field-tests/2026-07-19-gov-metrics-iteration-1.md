...
These are repository diff and instruction-surface measurements, not a controlled model or token comparison.
...
The Gov Metrics pull request still requires exact-head CI before merge. This field test shows a concrete simplification result; it does not prove Cave Pony outperforms both parent skills. Comparative research is deferred to cave-pony issue #11.
