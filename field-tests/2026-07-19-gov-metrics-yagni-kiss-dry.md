...
This field test supports the design and precedence of the three principles. It does not prove comparative token or source-line superiority. Comparative research is deferred to cave-pony issue #11.
